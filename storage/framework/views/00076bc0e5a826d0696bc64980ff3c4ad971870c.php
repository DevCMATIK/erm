    ...
    <form class="" role="form"  id="trigger-form">
                    ...
                    <?php if(count($device->sensors) > 0): ?>
                        <optgroup label="<?php echo e($device->check_point->sub_zones->first()->name); ?>-<?php echo e($device->name); ?>">
                            <?php $__currentLoopData = $device->sensors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($s->id == $trigger->receptor_id): ?>
                                    <option value="<?php echo e($s->id); ?>" selected><?php echo e(strtoupper($s->full_address)); ?>-<?php echo e($s->name); ?></option>
                                <?php else: ?>
        ...
        <?php if($sensor->address->configuration_type == 'scale'): ?>
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="range_min" value="<?php echo e($trigger->range_min); ?>">
            </div>
            <div class="form-group">
                <label class="form-label">Rango Maximo</label>
                <input type="text" class="form-control"  name="range_max" value="<?php echo e($trigger->range_max); ?>">
            </div>
            <div class="form-group">
                <label class="form-label">Comando a ejecutar cuando mayor que maximo</label>
                <select name="in_range" class="form-control">
                    <?php if($trigger->in_range === 1): ?>
        ...
        <?php else: ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="when_one" value="<?php echo e($trigger->when_one); ?>">
            </div>
            <div class="form-group">
                <label class="form-label">Cuando es Cero</label>
                <input type="text" class="form-control"  name="when_zero" value="<?php echo e($trigger->when_zero); ?>">
            </div>
        <?php endif; ?>
...
<?php $__env->startSection('modal-validation'); ?>
    <?php echo makeValidation('#trigger-form','/sensor-triggers/'.$trigger->id, "tableReload(); closeModal();"); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('components.modals.form-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/water-management/resources/views/water-management/device/sensor/trigger/edit.blade.php ENDPATH**/ ?>