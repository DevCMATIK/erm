    ...
    <div class="col-xl-12">
        <div class="row ">
            <div class="col-xl-2 cursor-pointer" onclick="downloadConsumptions();">
                <div class="px-2 py-1 bg-primary has-popover rounded overflow-hidden position-relative text-white mb-1 text-center "   data-toggle="popover" data-trigger="hover" data-placement="top" title="" data-content="<?php echo e(number_format($this_month_sub_zone,2,',','.')); ?> kWh" data-original-title="Consumo Mes Actual" >
                    <div class="">
                        <h3 class="display-4 d-block l-h-n m-0 fw-500"  >
                                <span class="text-white"  id="" >
                                    <span class="hidden-lg-up" > <?php echo e(number_format($this_month_sub_zone,2,',','.')); ?></span>
                                    <span class="hidden-md-down" style="font-size: 0.7em !important;"><?php echo e(shortBigNumbers($this_month_sub_zone)); ?></span>
                                    <span class="fs-nano">
                                    kWh
                                    </span>
                                </span>
            ...
            <div class="col-xl-2 cursor-pointer" onclick="downloadConsumptions();">
                <div class="px-2 py-1 bg-primary has-popover rounded overflow-hidden position-relative text-white mb-1 text-center " data-toggle="popover" data-trigger="hover" data-placement="top" title="" data-content="<?php echo e(number_format($last_month_sub_zone,2,',','.')); ?> kWh" data-original-title="Consumo Mes Anterior" >
                    <div class="">
                        <h3 class="display-4 d-block l-h-n m-0 fw-500" >
                                <span class="text-white"  id="" >
                                    <span class="hidden-md-down" style="font-size: 0.7em !important;"><?php echo e(shortBigNumbers($last_month_sub_zone)); ?></span>
                                    <span class="hidden-lg-up"><?php echo e(number_format($last_month_sub_zone,2,',','.')); ?></span>
                                    <span class="fs-nano">
                                    kWh
                                    </span>
                                </span>
            ...
            <div class="col-xl-2 cursor-pointer" onclick="downloadConsumptions();">
                <div class="px-2 py-1 bg-info has-popover rounded overflow-hidden position-relative text-white mb-1 text-center " data-toggle="popover" data-trigger="hover" data-placement="top" title="" data-content="<?php echo e(number_format($this_month_consumption,2,',','.')); ?> kWh" data-original-title="Consumo <?php echo e($subZone->zone->name); ?> Mes Actual" >
                    <div class="">
                        <h3 class="display-4 d-block l-h-n m-0 fw-500" >
                                <span class="text-white "  id="" >
                                    <span class="hidden-md-down" style="font-size: 0.7em !important;"> <?php echo e(shortBigNumbers($this_month_consumption)); ?></span>
                                    <span class="hidden-lg-up"> <?php echo e(number_format($this_month_consumption,2,',','.')); ?></span>

                                    <span class="fs-nano ">
                                    kWh
                                    </span>
                                </span>
                            <small class="m-0 l-h-n font-weight-bolder fs-nano">Consumo <?php echo e($subZone->zone->name); ?> Mes Actual</small>
                        </h3>
                    </div>
                </div>
            </div>
            <div class="col-xl-2 cursor-pointer" onclick="downloadConsumptions();" >
                <div class="px-2 py-1 bg-info has-popover rounded overflow-hidden position-relative text-white mb-1 text-center " data-toggle="popover" data-trigger="hover" data-placement="top" title="" data-content="<?php echo e(number_format($last_month_consumption,2,',','.')); ?> kWh" data-original-title="Consumo <?php echo e($subZone->zone->name); ?> Mes Anterior"  >
                    <div class="">
                        <h3 class="display-4 d-block l-h-n m-0 fw-500" >
                                <span class="text-white"  id="" >
                                    <span class="hidden-md-down" style="font-size: 0.7em !important;"> <?php echo e(shortBigNumbers($last_month_consumption)); ?></span>
                                    <span class="hidden-lg-up"> <?php echo e(number_format($last_month_consumption,2,',','.')); ?></span>
                                    <span class="fs-nano">
                                    kWh
                                    </span>
                                </span>
                            <small class="m-0 l-h-n font-weight-bolder fs-nano">Consumo <?php echo e($subZone->zone->name); ?> Mes Anterior</small>
                        </h3>
                    </div>
                </div>
            </div>
            <div class="col-xl-2">
                <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($key == 'ee-frecuencia' ): ?>
                        <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $analogous): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $value = array();
                            ...
                            <div class="px-2 py-1 bg-secondary rounded overflow-hidden position-relative text-white mb-1 text-center " >
                                ...
                                <span class="text-white"  id="" >
                                    ...
                                    <span class="fs-nano">
                                        ...
                                        <small class="m-0 l-h-n font-weight-bolder fs-nano"><?php echo e($sensor_name); ?></small>
                                    </h3>
                                </div>
                            </div>
            ...
            <div class="col-xl-2">
                <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($key == 'ee-factor-de-potencia' ): ?>
                        <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $analogous): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $value = array();
                                ...
                                <div class="row">
                                    <div class="col-xl-3" id="energy-values-container" >
                                        <div class="row">
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($key == 'ee-e-activa' || $key == 'ee-e-reactiva' || $key == 'ee-e-aparente' ): ?>
                                                    <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $analogous): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php echo $__env->make('water-management.dashboard.views.electric.analogous',[
                                    ...
                                    ?>
                                    <input type="hidden" id="energy-sensors" value="<?php echo e($energy_sensors); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-container show">
                            ...
                            <div class="panel-content p-1">
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                    <input type="hidden" id="stream-sensors" value="<?php echo e($stream_sensors); ?>">
                                    <input type="hidden" id="ss" value="<?php echo e($stream_sensor); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-container show ">
                            <div class="panel-content p-1">
                                <div class="row">
                                    ...
                                    ?>
                                    <input type="hidden" value="<?php echo e($ll_avr); ?>" id="ll-avr">
                                    <input type="hidden" value="<?php echo e($ln); ?>" id="ts-ln">
                                    <input type="hidden" value="<?php echo e($ln_avr); ?>" id="ln_avr">
                                    <input type="hidden" value="<?php echo e($tension_sensors); ?>" id="ts">
                                </div>
                                </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-container show">
                            <div class="panel-content p-1" >
                                <div class="row">
                                                ...
                                                <div class="btn-group btn-group-xs btn-block mb-2 btn-group-toggle" data-toggle="buttons">
                                                    ...
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <label class="btn btn-outline-secondary btn-power btn-xs active"   onclick="powerOptions('pot-lineas'); handlePower('pot-lineas');">
                                                            <input type="radio" name="sensors" id="checkpot-lineas" class="powsensors" value="<?php echo e(implode(',',$avr)); ?>" checked="checked" > <?php echo e($label); ?>
                                                    ...
                                                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php
                                                            ...
                                                            $label = '';
                                                        ?>
                                                        <?php if($key == 'ee-p-activa' || $key == 'ee-p-reactiva' || $key == 'ee-p-aparente'): ?>
                                                            <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $analogous): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php
                                                                ...
                                                                ?>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <label class="btn btn-outline-secondary btn-power btn-xs align-items-center"  onclick="powerOptions('<?php echo e($label); ?>'); handlePower('NOPL');">
                                                                <input type="radio" name="sensors" id="check<?php echo e($label); ?>" class="powsensors" value="<?php echo e(implode(',',$powerS)); ?>" > <?php echo e($label); ?>
                                    ...
                                    <input type="hidden" id="power-sensors" value="<?php echo e($power_sensors); ?>">
                                    <input type="hidden" id="ps" value="<?php echo e($power_sensor); ?>">
                                </div>
...
<?php if(count($check_point_kpis ) > 0): ?>
    ...
    <?php $__currentLoopData = $check_point_kpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kpi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row mt-4">
            <?php echo $__env->make('water-management.dashboard.partials.kpi.cost-kpi',['fullView' => 'full'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<input type="hidden" value="<?php echo e(implode(',',$avr)); ?>" id="power-options">
...
<script>
    ...
    function downloadConsumptions() {
        location.href = '/downloadConsumptions/<?php echo e($subZone->id); ?>';
    }
...
<?php /**PATH /shared/httpd/erm/resources/views/water-management/dashboard/views/content-electric.blade.php ENDPATH**/ ?>