<div class="row">
    <div class="col-sm-4 col-xl-4">
        <div class="p-3 bg-warning rounded overflow-hidden position-relative text-white mb-g" <?php if(Sentinel::getUser()->inGroup('cmatik')): ?> onClick="redirectToOfflineDevices()" <?php else: ?> onclick="redirectToOfflineDev()" <?php endif; ?>>
            <div class="">
...
<?php /**PATH /shared/httpd/water-management/resources/views/water-management/dashboard/statistics/small-boxes.blade.php ENDPATH**/ ?>