...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 700px;" class="content">
    ...
    <?php if (! empty(trim($__env->yieldContent('mail-header')))): ?>
        <tr>
            <td align="left" bgcolor="#ffffff" style=" border-bottom: 1px dotted #f1f1f1;">
                <?php echo $__env->yieldContent('mail-header'); ?>
            </td>
        </tr>
    <?php endif; ?>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center" width="100%" style="color: #414141; font-family: Arial, sans-serif; font-size: 12px;">
                        <?php echo e(\Carbon\Carbon::today()->year); ?> &copy; Cmatik - <?php echo e(config('app.name')); ?>
...
<?php /**PATH /shared/httpd/water-management/resources/views/emails/base.blade.php ENDPATH**/ ?>