...
<?php $__env->startSection('page-content'); ?>
    ...
    <form method="post" action="/downloadDataFromChartTotal" id="data-form">
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/water-management/resources/views/data/exports/index2.blade.php ENDPATH**/ ?>
