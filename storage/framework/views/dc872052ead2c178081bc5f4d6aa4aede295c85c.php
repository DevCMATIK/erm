...
<?php if(isset($analogous_sensor)): ?>
    <?php if($disposition): ?>
        <?php echo $__env->make('water-management.dashboard.control.html.analogous', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php else: ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /shared/httpd/water-management/resources/views/water-management/dashboard/control/analogous.blade.php ENDPATH**/ ?>