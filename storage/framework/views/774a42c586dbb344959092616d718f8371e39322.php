...
<div class="page-wrapper">
    <div class="page-inner ">
        ...
        <div class="page-content-wrapper">
            <!-- BEGIN Page Header -->
        <?php echo $__env->make('layouts.sections.header-blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- END Page Header -->
            <!-- BEGIN Page Content -->
...
<?php /**PATH /shared/httpd/water-management/resources/views/layouts/app-blank.blade.php ENDPATH**/ ?>