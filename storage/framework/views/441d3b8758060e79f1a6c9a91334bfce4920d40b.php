                        ...
                        <td>
                            <?php $__currentLoopData = explode(',',$permission->list); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="<?php echo e($permission->slug); ?> custom-control-input" name="perms[]" id="<?php echo e($permission->slug.".".$p); ?>" value="<?php echo e($permission->slug.".".$p); ?>" <?php if($role->hasAccess([$permission->slug.".".$p])): ?> checked <?php endif; ?>>
...
<?php $__env->startSection('modal-validation'); ?>
    <?php echo makeValidation('#role-permissions-form','/rolePermissions/'.$role->id, "tableReload(); closeModal();"); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('modal-width','60'); ?>

<?php echo $__env->make('components.modals.form-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/water-management/resources/views/system/role/permissions/index2.blade.php ENDPATH**/ ?>
