...
<?php $__env->startSection('page-content'); ?>
    ...
    <script>
        ...
        function getDataFromSubZone() {
            ...
            $.get('/admin/SubZone/'+subZone, function(data){
        ...
        function resetGrid(id)
        {
            $.ajax({
                ...
                {
                    toastr.success('Grilla reseteada');
                    showGrid(id)
                }
            });
        }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/water-management/resources/views/water-management/admin/device/index2.blade.php ENDPATH**/ ?>
