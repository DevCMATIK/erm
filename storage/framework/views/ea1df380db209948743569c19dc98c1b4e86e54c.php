...
<?php $__env->startSection('modal-title','Crear Reporte de email'); ?>
<?php $__env->startSection('modal-content'); ?>
    ...
    <script>
        $(document).ready(function(){
            ...
            {
                let sensors = [];
                $.each($("input[name='sensor_id']:checked"), function(){
...
<?php $__env->startSection('modal-validation'); ?>
    <?php echo makeValidation('#mail-report-form','/mail-reports', "tableReload(); closeModal();"); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('components.modals.form-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/water-management/resources/views/water-management/report/create.blade.php ENDPATH**/ ?>