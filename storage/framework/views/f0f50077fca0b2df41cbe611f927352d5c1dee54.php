        ...
        <div class="col-xl-12 table-responsive">
            <table class="table table-striped">
                <tr>
                    ...
                    <td><?php echo e($trigger->sensor->name.' Dispositivo: '.$trigger->sensor->device->name); ?></td>
                </tr>
                <tr>
                    <th>Sensor Receptor</th>
                    <td><?php echo e($trigger->receptor->name.' Dispositivo: '.$trigger->receptor->device->name); ?></td>
                </tr>
...
<?php echo $__env->make('components.modals.form-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/water-management/resources/views/water-management/device/sensor/trigger/logs.blade.php ENDPATH**/ ?>