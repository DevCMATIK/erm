...
<div class="p-3 <?php echo e($class); ?> rounded overflow-hidden position-relative text-white mb-g " >
       ...
       <div class="">
             <h3 class="display-4 d-block l-h-n m-0 fw-500" >
                <a class="text-white" href="/getDataAsChart/<?php echo e($analogous_sensor->sensor->device_id); ?>/<?php echo e($analogous_sensor->sensor->id); ?>"  <?php echo makeLinkRemote(); ?> id="" >
                    <?php if(is_string($data)): ?>
                       <?php echo e($data); ?>

                    <?php else: ?>
                        <?php echo e($data); ?><span class="fs-nano">
                        <?php echo e(strtoupper(optional(optional($disposition)->unit)->name)); ?></span>
                    <?php endif; ?>
                </a>
...
<?php /**PATH /shared/httpd/erm/resources/views/water-management/dashboard/control/html/analogous-electric.blade.php ENDPATH**/ ?>