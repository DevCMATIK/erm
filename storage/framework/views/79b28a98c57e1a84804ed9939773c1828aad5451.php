...
<script>
    ...
    function procesar(){
        ...
        if(pausa == 0){
            $.ajax({
                type : "GET",
                url : '/importFileProcess/<?php echo e($importFile->import->slug); ?>/<?php echo e($importFile->id); ?>',
                dataType: "json",
    ...
    function progressBar()
    {
        $.ajax({
            type : "GET",
            url : "/importFile/progressBar/<?php echo e($importFile->id); ?>",
            contentType: false,
            processData: false,
    ...
    function finalizar(){
        ...
        location.href = "/importFile/<?php echo e($importFile->import->slug); ?>";
    }
</script>



<?php /**PATH /shared/httpd/water-management/resources/views/system/import/import-file/process.blade.php ENDPATH**/ ?>