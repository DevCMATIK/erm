<script>
    function getEnergyChartContainer(date){
        ...
        $.getJSON('/getEnergyChart/<?php echo e($subZone->id); ?>?date='+date+'&sensors='+sensors, function (data) {
            var options = {
                chart: {
...
<?php /**PATH /shared/httpd/erm/resources/views/water-management/dashboard/views/electric/charts/energy-chart.blade.php ENDPATH**/ ?>