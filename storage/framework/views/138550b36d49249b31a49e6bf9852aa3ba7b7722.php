<script>
    function getDailyAveragesChart(){
        let date = $('#date').val();
        $.getJSON('/getDataForChartDailyAverage/<?php echo e($device_id); ?>/<?php echo e($sensor_id); ?>?date='+date, function (data) {
            var options3 = {
                chart: {
...
<?php /**PATH /shared/httpd/water-management/resources/views/water-management/dashboard/chart/charts/daily-averages.blade.php ENDPATH**/ ?>