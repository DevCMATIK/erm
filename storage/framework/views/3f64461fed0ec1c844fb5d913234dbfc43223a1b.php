            ...
            <div class="dd" id="nestable">
                <ol class="dd-list">
                    <?php $__currentLoopData = $sub_zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="dd-item border" data-id="<?php echo e($sub_zone->id); ?>">
                            <div class="dd-handle">
                                 <?php echo e($sub_zone->name); ?>

                                <span class="label label-primary float-right"><?php echo e($sub_zone->position); ?></span>
                            </div>
                        </li>
...
<?php $__env->startSection('modal-validation'); ?>
    <?php echo makeValidation('#zone-serialization-form','/subZoneSerialization/'.$zone->id, "tableReload(); closeModal();"); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('components.modals.form-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/water-management/resources/views/client/zone/sub/serialize.blade.php ENDPATH**/ ?>