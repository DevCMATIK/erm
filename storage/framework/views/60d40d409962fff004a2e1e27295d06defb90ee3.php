...
<?php endif; ?>
        <h2 class=" mb-0 text-<?php echo e($color); ?>"><span class="font-weight-bolder " style=" font-size: 0.9em !important;"><?php echo e($data); ?></span> <span class="fs-nano text-dark"><?php echo e(strtoupper(optional(optional($disposition)->unit)->name)); ?></span></h2>
...
<?php endif; ?>
<?php /**PATH /shared/httpd/water-management/resources/views/water-management/dashboard/control/html/analogous.blade.php ENDPATH**/ ?>