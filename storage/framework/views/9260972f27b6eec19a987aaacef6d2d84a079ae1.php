                ...
                <div class="card-body">
                    <ul class="list-group">
                        <?php $__currentLoopData = $check_point->devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $device->sensors->sortByDesc('address.configuration_type'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sensor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($sensor->type->is_exportable === 1): ?>
...
<?php /**PATH /shared/httpd/erm/resources/views/data/exports/check-points.blade.php ENDPATH**/ ?>