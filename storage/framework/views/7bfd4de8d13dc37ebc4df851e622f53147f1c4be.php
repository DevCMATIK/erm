            ...
            <table bgcolor="#0073AA" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
                <tr>
                    <td align="center" height="50" style=" padding: 0 25px 0 25px; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold;" class="button">
                        <a href="<?php echo e(env('APP_URL')); ?>/reset/<?php echo e($user->email); ?>/<?php echo e($code); ?>" style="color: #ffffff; text-align: center; text-decoration: none;">Cambiar mi contraseña</a>
                    </td>
                </tr>
            </table>
        </td>
...
<?php echo $__env->make('emails.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /shared/httpd/water-management/resources/views/emails/auth/forgot-password.blade.php ENDPATH**/ ?>