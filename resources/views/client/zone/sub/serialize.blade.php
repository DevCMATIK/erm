...
@section('modal-title','Ordenar Sub Zonas')
            ...
            <div class="dd" id="nestable">
                <ol class="dd-list">
                    @foreach($sub_zones as $sub_zone)
                        ...
                        <li class="dd-item border" data-id="{{ $sub_zone->id}}">
                            <div class="dd-handle">
                                 {{ $sub_zone->name }}
                                <span class="label label-primary float-right">{{ $sub_zone->position }}</span>
                            </div>
                        </li>
                    @endforeach
                </ol>
...
@section('modal-validation')
    {!!  makeValidation('#zone-serialization-form','/subZoneSerialization/'.$zone->id, "tableReload(); closeModal();") !!}
@endsection
