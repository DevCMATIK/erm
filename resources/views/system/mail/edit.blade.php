@extends('layouts.app')
@section('page-title','Editar Mail: '.$mail->name)
                    ...
                    <div class="panel-content">
                        <form  role="form"  id="mail-form">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-5">
                                        ...
                                        <input type="text" class="form-control"  name="name" value="{{ $mail->name }}">
                                    </div>
                                    <div class="col-5">
                                    ...
                                    <div class="col-2">
                                        <label class="custom-control custom-checkbox">
                                            ...
                                            <input type="checkbox" class="custom-control-input" value="1" name="share_with_all" @if($mail->share_with_all == 1) checked @endif>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="header" class="js-summernote" id="header">{{ $mail->header }}</textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Cuerpo del correo</label>
                                <textarea name="body" class="js-summernote" id="body">{{ $mail->body }}</textarea>
                            </div>
