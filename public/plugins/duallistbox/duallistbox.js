;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextFiltered: '<span class="label label-warning">Filtrados</span> {0} al {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'Listado vacio',                                                        // when there are no options present in the list
